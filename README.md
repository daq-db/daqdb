...
Offload of KV pairs is supported to SSD NVMe drives. For the performance reasons it's recommended to use NVMe Optane drives since those support very high IO and GB/s rates for types of loads that are generated by daqdb.
