...
ConfEntry::ConfEntry(const string &sconfigEntry) { assign(sconfigEntry); }
...
string ConfEntry::name() const { return _name; }

void ConfEntry::name(const string &name) { _name = name; }

string ConfEntry::value() const { return _value; }

void ConfEntry::value(const string &value) { _value = value; }

string ConfEntry::operator()() const { return toString(); }
...
string ConfEntry::getFormat() { return "%s,%s"; }
