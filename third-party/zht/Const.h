...
class Const {
  ...
  public:
    ...
    static string concat(const TYPE1 &ele1, const TYPE2 &ele2);
    template <class TYPE1, class TYPE2>
    static string concat(const TYPE1 &ele1, const string &delimiter,
                         const TYPE2 &ele2);
  ...
  public:
    ...
    static const int
        ADDR_UUIDZERO; // used to remember if the address is changed.
    ...
    static const string
        ZSC_OPC_GET_ASNGHB; // get information of ZHTNode as a neighbor
    static const string ZSC_OPC_BRD_GMEM; // broadcast global membership to zht,
                                          // triggered by broadcast
    static const string ZSC_OPC_GET_GMEM; // get global membership from zht
    static const string
        ZSC_OPC_GET_DESTZHT; // get destination zht to service client request
    static const string ZSC_OPC_PULLFILE; // pull file from source zht server
    static const string
        ZSC_OPC_MIGDONETGT; // inform target zht that migrage is done
    static const string
        ZSC_OPC_MIGDONESRC; // inform source zht that migrage is done
    ...
    static const string ZSC_OPC_PING;
    ...
    static const string
        ZSC_REC_SCCBPOLLTRY;            // retry state_change_callback polling
    ...
    static const int
        ZSI_OPC_GET_ASNGHB; // get information of ZHTNode as a neighbor
    static const int ZSI_OPC_BRD_GMEM; // broadcast global membership to zht,
                                       // triggered by broadcast
    static const int ZSI_OPC_GET_GMEM; // get global membership from zht
    static const int
        ZSI_OPC_GET_DESTZHT; // get destination zht to service client request
    static const int ZSI_OPC_PULLFILE; // pull file from source zht server
    static const int
        ZSI_OPC_MIGDONETGT; // inform target zht that migrage is done
    static const int
        ZSI_OPC_MIGDONESRC; // inform source zht that migrage is done
